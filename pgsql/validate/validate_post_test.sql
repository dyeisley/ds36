...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '========================================================================';
    RAISE NOTICE '--- CART SIZE BY MEMBERSHIP TIER ---';
    RAISE NOTICE 'Verifying: Cart size formula and unlimited cart feature';
    RAISE NOTICE 'Expected: Average cart size = Random(1, 2*n_line_items) + tier';
    RAISE NOTICE 'Expected: Max cart size >10 when n_line_items >5 (proves PURCHASE_TVP works)';
    RAISE NOTICE 'Expected: Min cart size = 1 for N/A, 2 for tier 1, 3 for tier 2, 4 for tier 3';
    RAISE NOTICE 'NOTE: Customers becoming members or changing tiers after placing orders';
    RAISE NOTICE '      will cause historical orders to be classified by their current tier,';
    RAISE NOTICE '      potentially reducing Min cart size results.';
    RAISE NOTICE '========================================================================';
    RAISE NOTICE '';
END $$;
...
ORDER BY COALESCE(m.MEMBERSHIPTYPE, -999);
