...
# Syntax: perl pgsql_ds_perl_validate_multi.pl <server> <num_stores> <pre_test|post_test> [generate|execute]
...
if (!defined $pgsqltarget || !defined $numberofstores || !defined $mode) {
    print "Usage: perl pgsql_ds_perl_validate_multi.pl <server> <num_stores> <pre_test|post_test> [generate|execute] [popular_modulo]\n";
    print "\nExamples:\n";
    print "  perl pgsql_ds_perl_validate_multi.pl localhost 3 pre_test generate\n";
    print "  perl pgsql_ds_perl_validate_multi.pl localhost 3 pre_test execute\n";
    print "  perl pgsql_ds_perl_validate_multi.pl localhost 3 pre_test both 1000\n";
    print "  perl pgsql_ds_perl_validate_multi.pl localhost 3 pre_test (defaults to both, modulo 10000)\n";
    exit 1;
}
