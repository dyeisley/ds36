ds36_pgsql_build_readme.txt

Instructions for building DVD Store Version 3.5 (DS36) database

It is recommended to run pgsql_ds_create_all in the ds36/pgsql directory.  That script uses the
...
The pgsql_ds_cleanup_XXXXXXX scripts are run to get the database back to the state it was after initial 
