...
Updated to include 500 popular actor names. Titles are generated by choosing two random words from the list.

To compile for writing directly to prod.csv
	gcc -o  ds3_create_prod ds3_create_prod.c -lm

To compile with nice human readable columns with output directed to the screen
	gcc -DNICE ds3_create_prod ds3_create_prod.c -lm
