...
dbms_stats.gather_index_stats(ownname=> 'DS3', indname=> 'IX_PROD_SPECIAL_CATEGORY$k', partname=> NULL );
...
dbms_stats.gather_index_stats(ownname=> 'DS3', indname=> 'IX_CUST_HIST_CUSTOMERID_PRODID$k', partname=> NULL , estimate_percent=> 18 );
dbms_stats.gather_index_stats(ownname=> 'DS3', indname=> 'IX_CUST_UN_PW$k', partname=> NULL , estimate_percent=> 18 );
...
dbms_stats.gather_index_stats(ownname=> 'DS3', indname=> 'IX_REVIEWS_PROD_HELP$k', partname=> NULL , estimate_percent=> 18 );
dbms_stats.gather_index_stats(ownname=> 'DS3', indname=> 'IX_REVIEWS_PRODSTARS_HELP$k', partname=> NULL , estimate_percent=> 18 );
dbms_stats.gather_index_stats(ownname=> 'DS3', indname=> 'IX_REVIEWS_PROD_DATE$k', partname=> NULL , estimate_percent=> 18 );
end;
/
exit;
\n";
