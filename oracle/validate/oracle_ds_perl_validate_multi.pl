...
# Syntax: perl oracle_ds_perl_validate_multi.pl <server> <num_stores> <before|after> [generate|execute]
...
if (!defined $oracletarget || !defined $numberofstores || !defined $mode) {
    print "Usage: perl oracle_ds_perl_validate_multi.pl <server> <num_stores> <before|after> [generate|execute]\n";
    print "\nExamples:\n";
    print "  perl oracle_ds_perl_validate_multi.pl localhost 3 before generate\n";
    print "  perl oracle_ds_perl_validate_multi.pl localhost 3 before execute\n";
    print "  perl oracle_ds_perl_validate_multi.pl localhost 3 before (both)\n";
    exit 1;
}
