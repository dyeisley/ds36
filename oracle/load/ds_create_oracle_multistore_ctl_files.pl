...
foreach my $k (1 .. $numberofstores){
	open (my $OUT, ">cust\\$oracletargetdir\\remote_oracle_ds_cust_sqlldr$k.bat") || die("Can't open remote_oracle_ds_cust_sqlldr$k.bat");
    ...
    #sleep(.1);
	#system ("move remote_oracle_ds_cust_sqlldr$k.bat $oracletargetdir/cust\\");
...
# Orders 
foreach my $k (1 .. $numberofstores){
	open (my $OUT, ">orders\\$oracletargetdir\\remote_oracle_ds_orders_sqlldr$k.bat") || die("Can't open remote_oracle_ds_orders_sqlldr$k.bat");
	...
	system ("perl ds_create_oracle_sqlldr_ctl.pl orders$k ORDERS orders\\$oracletargetdir\\nov_orders$k.ctl NOV2013");
	system ("perl ds_create_oracle_sqlldr_ctl.pl orders$k ORDERS orders\\$oracletargetdir\\dec_orders$k.ctl DEC2013");
    #sleep(.1);
	#system ("move remote_oracle_ds_orders_sqlldr$k.bat $oracletargetdir/orders\\");
	#system ("move *orders$k.ctl $oracletargetdir/orders\\");
}

# Orderlines 
foreach my $k (1 .. $numberofstores){
	open (my $OUT, ">orders\\$oracletargetdir\\remote_oracle_ds_orderlines_sqlldr$k.bat") || die("Can't open remote_oracle_ds_orderlines_sqlldr$k.bat");
	...
	system ("perl ds_create_oracle_sqlldr_ctl.pl orderlines$k ORDERLINES orders\\$oracletargetdir\\nov_orderlines$k.ctl NOV2013");
	system ("perl ds_create_oracle_sqlldr_ctl.pl orderlines$k ORDERLINES orders\\$oracletargetdir\\dec_orderlines$k.ctl DEC2013");
    #sleep(.1);
	#system ("move remote_oracle_ds_orderlines_sqlldr$k.bat $oracletargetdir/orders\\");
	#system ("move *orderlines$k.ctl $oracletargetdir/orders\\");
}
# cust_hist 
foreach my $k (1 .. $numberofstores){
	open (my $OUT, ">orders\\$oracletargetdir\\remote_oracle_ds_cust_hist_sqlldr$k.bat") || die("Can't open remote_oracle_ds_cust_hist_sqlldr$k.bat");
	...
	#sleep(.1);
	#system ("move remote_oracle_ds_cust_hist_sqlldr$k.bat $oracletargetdir/orders\\");
	#system ("move cust_hist$k.ctl $oracletargetdir/orders\\");
}

# prod
foreach my $k (1 .. $numberofstores){
	open (my $OUT, ">prod\\$oracletargetdir\\remote_oracle_ds_prod_sqlldr$k.bat") || die("Can't open remote_oracle_ds_prod_sqlldr$k.bat");
	...
	#sleep(.1);
	#system ("move remote_oracle_ds_prod_sqlldr$k.bat $oracletargetdir/prod\\");
	#system ("move prod$k.ctl $oracletargetdir/prod\\");
}

# inv
foreach my $k (1 .. $numberofstores){
	open (my $OUT, ">prod\\$oracletargetdir\\remote_oracle_ds_inv_sqlldr$k.bat") || die("Can't open remote_oracle_ds_inv_sqlldr$k.bat");
	...
	#sleep(.1);
	#system ("move remote_oracle_ds_inv_sqlldr$k.bat $oracletargetdir/prod\\");
	#system ("move inv$k.ctl $oracletargetdir/prod\\");
}
#membership
foreach my $k (1 .. $numberofstores){
	open (my $OUT, ">membership\\$oracletargetdir\\remote_oracle_ds_membership_sqlldr$k.bat") || die("Can't open remote_oracle_ds_membership_sqlldr$k.bat");
	...
	#sleep(.1);
	#system ("move remote_oracle_ds_membership_sqlldr$k.bat $oracletargetdir/membership\\");
	#system ("move membership$k.ctl $oracletargetdir/membership\\");
}

#reviews
foreach my $k (1 .. $numberofstores){
	open (my $OUT, ">reviews\\$oracletargetdir\\remote_oracle_ds_reviews_sqlldr$k.bat") || die("Can't open remote_oracle_ds_reviews_sqlldr$k.bat");
	...
	#sleep(.1);
	#system ("move remote_oracle_ds_reviews_sqlldr$k.bat $oracletargetdir/reviews\\");
