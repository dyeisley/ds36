...
chdir ("$base_dir");
system ("rm -f cust/$oracletargetdir/finished*.txt");
system ("rm -f orders/$oracletargetdir/finished*.txt");
system ("rm -f membership/$oracletargetdir/finished*.txt");
system ("rm -f prod/$oracletargetdir/finished*.txt");
system ("rm -f reviews/$oracletargetdir/finished*.txt");
