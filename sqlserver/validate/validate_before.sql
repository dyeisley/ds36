...
IF OBJECT_ID('VALIDATION_MEMBERSHIP_SAMPLE', 'U') IS NOT NULL
    DROP TABLE VALIDATION_MEMBERSHIP_SAMPLE;

SELECT TOP 10000 CUSTOMERID, MEMBERSHIPTYPE, EXPIREDATE
INTO VALIDATION_MEMBERSHIP_SAMPLE
FROM MEMBERSHIP1
ORDER BY NEWID();
